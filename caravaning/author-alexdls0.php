        ...
        <div class="row">
        	<div class="col-md-12">
        		<div class="row">
					...
					<div class="col-md-12">
						<div id="names"><h3 class="bactive" id="hards" ></h3></div></br>
						<div id="hbars">
							<div class="row d-flex justify-content-around">
									<div class="bar hbar d-flex flex-column align-items-center" data-percent="<?php the_author_meta('skill1V', $curatuh->ID); ?>">
										<p class="text-center"><?php the_author_meta('skill1', $curatuh->ID); ?></p>
										<canvas class="bar-circle" width="70" height="70"></canvas>
									</div>
							
								
									<div class="bar hbar d-flex flex-column align-items-center" data-percent="<?php the_author_meta('skill2V', $curatuh->ID); ?>">
										<p class="text-center"><?php the_author_meta('skill2', $curatuh->ID); ?></p>
										<canvas class="bar-circle" width="70" height="70"></canvas>
									</div>
								
								
									<div class="bar hbar d-flex flex-column align-items-center" data-percent="<?php the_author_meta('skill3V', $curatuh->ID); ?>">
										<p class="text-center"><?php the_author_meta('skill3', $curatuh->ID); ?></p>
										<canvas class="bar-circle" width="70" height="70"></canvas>
									</div>
								
									<div class="bar hbar d-flex flex-column align-items-center" data-percent="<?php the_author_meta('skill4V', $curatuh->ID); ?>">
										<p class="text-center"><?php the_author_meta('skill4', $curatuh->ID); ?></p>
										<canvas class="bar-circle" width="70" height="70"></canvas>
									</div>
