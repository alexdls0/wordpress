...
jQuery(document).ready(function() {
  jQuery("#hards").click(function() {
    jQuery(".sbar")
      .filter(function() { return !jQuery(this).is(":hidden"); })
      .fadeOut(100, function() {
        jQuery('.hbar,.hbars').fadeIn(100);
      });
    jQuery('#softs').removeClass("bactive");
    jQuery('#hards').addClass("bactive");
  });
});
